...
export const getMessages = async(req,res)=>{
    try{
        ...
        const messages = await Message.find({
            $or:[
                // this part is for fetching messages sent by me to selected user and this part is for fetching messages sent by selected user to me
...
export const markMessageSeen = async (req,res)=>{
    try{
        ...
        await Message.findByIdAndUpdate(_id,{seen:true})
